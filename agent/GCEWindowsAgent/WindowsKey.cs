...
namespace GCEAgent
{
  ...
  public class WindowsKey
  {
    ...
    /// <summary>
    /// Returns whether the key has an expiration timestamp in the past, or False otherwise.
    /// </summary>
    public bool HasExpired()
    {
      ...
      try
      {
        ...
        // Return true only if the current date is greater than the expiration time.
    ...
    /// </summary>
    /// <param name="windowsKey">The WindowsKey to convert to JSON.</param>
    /// <returns>The serialized JSON object as a string.</returns>
    public override string ToString()
    {
      WindowsKeyJson windowsKeyJson = new WindowsKeyJson();
      windowsKeyJson.Email = Email;
      windowsKeyJson.ExpireOn = ExpireOn;
      windowsKeyJson.Exponent = Exponent;
      windowsKeyJson.Modulus = Modulus;
      windowsKeyJson.UserName = UserName;
